import{_ as s,o as n,c as a,e as l}from"./app.08d28afd.js";const e={},i=l(`<h1 id="all-commands" tabindex="-1"><a class="header-anchor" href="#all-commands" aria-hidden="true">#</a> All Commands</h1><p>The list of all commands available in <code>asdf</code>. This list is the <code>asdf help</code> command text.</p><div class="language-txt line-numbers-mode" data-ext="txt"><pre class="shiki" style="background-color:#272822;"><code><span class="line"><span style="color:#F8F8F2;">MANAGE PLUGINS</span></span>
